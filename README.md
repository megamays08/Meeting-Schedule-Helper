...
- Export to CSV (spreadsheet-friendly) or ICS (imports into Outlook/Google) per series or all at once.
...
2. **Build a Series tab**: Add a meeting series, set its pattern/count/dates, click Generate. You'll get a short confirmation, the actual schedule lives in the next tab.
